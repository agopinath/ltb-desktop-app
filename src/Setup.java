...
// 6/14/2013
// Setup.java
// This class allows the user to enter their login credentials as well as set startup options during the program installation/first run
// and is very similar to Preferences.java
